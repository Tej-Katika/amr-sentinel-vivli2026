...
| 2 (secondary) | [`bayesian_excess_los.py`](src/amr_sentinel_vivli/bayesian_excess_los.py) | **Bayesian partial-pooled excess bed-days**: piecewise-exponential competing-risks (Laplace posterior), country pooling, null-centered prior → P(excess>0), P(excess>1d); flat/null/informative prior comparison with effective prior weight |
