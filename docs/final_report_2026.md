...
- **Resource realignment (Cross-Domain).** Burden, R&D *funding*, and disease *surveillance* are all misaligned with the same sub-Saharan-African community Gram-negatives; the two mismatch indices argue for steering both funding and surveillance toward access, diagnostics, and the neglected region — not novel compounds alone.
